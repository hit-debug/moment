  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.bgDeep }]}>
      <View style={[styles.header, { paddingTop: insets.top }]}>
        ...
        <Text style={styles.headerTitle}>명언 선호 재설정</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      >
        <View style={styles.hero}>
          <Text style={styles.heroTitle}>관심 있는 주제를 다시 선택해주세요</Text>
        ...
        <Text style={styles.footerInfo}>선택한 주제 중심으로 명언을 추천해드려요</Text>
